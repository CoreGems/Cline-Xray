<script lang="ts">
  // REST Subtab - Displays REST API access logs
  import { onMount, onDestroy } from 'svelte';
  import type { AccessLogEntry } from './types';
  import { fetchAccessLogs, clearAccessLogs } from './api';
  import { formatTimestamp, getStatusColor, getMethodColor } from './utils';

  let logs: AccessLogEntry[] = $state([]);
